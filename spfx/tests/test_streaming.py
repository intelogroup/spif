...
from spfx import SPIFDocument, Node, Distribution, Provenance, TraceStep
from spfx.streaming import SPIFStreamWriter, SPIFStreamReader, iter_events
from spfx.reader import SPIFReader, SPIFChecksumError, SPIFFormatError
from spfx.format import CHUNK_PARTIAL_TEXT, FLAG_STREAMING, MAGIC, FORMAT_VERSION
...
from spfx.streaming import _make_resume_token, _parse_resume_token
...
class TestStreamResume:
    ...
    def test_resume_emits_stream_resume_chunk(self):
        ...
        from spfx.format import CHUNK_STREAM_RESUME, MAGIC
        import struct
