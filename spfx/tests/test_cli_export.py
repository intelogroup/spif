...
from spfx.cli import app
from spfx.exporters.msgpack import from_msgpack
from spfx.types import SPIFDocument, Node, Provenance, Distribution, TraceStep
...
class TestExportLosslessJson:
    ...
    def test_export_roundtrip_via_from_lossless_json(self, tmp_path):
        ...
        result = runner.invoke(app, ["export", str(path), "--lossless-json"],
                               catch_exceptions=False)
        from spfx.exporters.lossless_json import from_lossless_json
