import pytest
from spfx import SPIFWriter, SPIFReader, SPIFDocument, Node, Distribution
from spfx import SPIFMagicError, SPIFChecksumError, SPIFFormatError
...
def test_missing_payload_raises():
    ...
    import hashlib
    import cbor2
    from spfx.format import MAGIC, FORMAT_VERSION, CHUNK_HEADER, CHUNK_CHECKSUM
...
def test_empty_payload_raises_format_error():
    ...
    import hashlib
    import cbor2
    from spfx.format import MAGIC, FORMAT_VERSION, CHUNK_HEADER, CHUNK_PAYLOAD, CHUNK_CHECKSUM
