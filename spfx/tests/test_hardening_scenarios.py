...
from spfx.format import CHUNK_SIGNATURE, CHUNK_CHECKSUM, MAGIC, FORMAT_VERSION, CHUNK_HEADER, CHUNK_PAYLOAD, TAG_DISTRIBUTION
...
def test_decompression_bomb_denial_of_service():
    ...
    from spfx.format import FLAG_COMPRESSED
    header_chunk_data = cbor2.dumps({
        "version": FORMAT_VERSION,
        "flags": flags,
