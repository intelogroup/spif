...
from spfx import SPIFDocument, Node, TraceStep, Distribution, Signature, SPIFWriter, SPIFReader
from spfx.format import MAGIC
from spfx.reader import _validate_trace_dag  # internal, used only to isolate DAG cost
