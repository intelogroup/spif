...
9. `NodeRef` - 90 edges
10. `SPIFStreamWriter` - 89 edges

## Surprising Connections (you probably didn't know these)
- `FormatStats` --uses--> `Distribution`  [INFERRED]
  benchmarks/adversarial_resistance_bench.py → spif/types.py
...
Cohesion: 0.12
Nodes (22): CRLClient, PolicyEvaluator, Path, Evaluates SPIF documents against a validation policy., Client for fetching and caching Certificate Revocation Lists (CRL)., Return the set of revoked signer identifiers, updating from URL if TTL expired., Start the sidecar HTTP proxy server., start_sidecar() (+14 more)
...
Cohesion: 0.10
Nodes (22): check_revocation(), export_pem_private_key(), export_pem_public_key(), generate_key(), load_pem_private_key(), load_revocation_list(), Ed25519PrivateKey, Path (+14 more)
...
### Community 39 - "format.py"
Cohesion: 0.11
Nodes (29): command, export(), hexdump(), inspect(), Path, SPIF command-line interface., Show the raw chunk structure of a SPIF file., Sign a SPIF file with an ed25519 private key. (+21 more)

### Community 40 - "SPIFDocument"
Cohesion: 0.14
Nodes (18): main(), Test 7 — Replay protection + EU AI Act compliance fields. Pass: (a) re-…, Example: minimal SIF document — a single fact node., Example: SIF document with full reasoning trace DAG., SPIFRenderer, ReplayGuard, A complete SPIF document., Derived status: 'failed' if any tool_result node has is_error=True, else 'ok'. (+10 more)
...
### Community 72 - "SidecarHTTPHandler"
Cohesion: 0.16
Nodes (11): generate_fpr_document(), _provenance_to_dict(), Any, BaseHTTPRequestHandler, Provenance, SPIFDocument, Validate a SPIF payload against the configuration policy and CRL. Returns a…, Generate a standard compliant Failing Provenance Record (FPR) SPIFDocument. (+3 more)
...
Cohesion: 0.18
Nodes (5): SPIFDocument, TestExportLosslessJson, TestExportMsgpack, TestRenderWarning, _write_spif()
...
Cohesion: 0.40
Nodes (5): SPIFDocument, Roadmap item: validate CBOR tagging across languages for interoperability.…, Sanity control: the same document must round-trip in Python too., _tagged_doc(), test_python_encoded_tags_still_decode_in_python()
...
### Community 110 - "cross_org_handoff.py"
Cohesion: 0.21
...
### Community 121 - "SPIF (Semantic Provenance Inference Format)"
Cohesion: 0.25
Nodes (7): Community and Contributions, For Buyers, Getting Started, Key Features, Overview, Pricing, SPIF (Semantic Provenance Inference Format)

### Community 122 - "test_dag_dos_benchmark.py"
Cohesion: 0.43
...
### Community 132 - "expressiveness_compare.py"
Cohesion: 0.43
...
### Community 134 - "Open-Core Model for SPIF"
Cohesion: 0.33
Nodes (5): Commercial Components, Conclusion, Introduction, Open-Core Model for SPIF, Open Source Components

### Community 135 - "otel.py"
Cohesion: 0.40
